...
$$\rm C_8H_{12}O_3N_2 + 3O_2 \rightarrow C_5H_7O_2N + NH_3 + 3CO_2 + H_2O$$
...
- 根據半反應式：  
$$\rm \frac{1}{20}C_5H_7O_2N + \frac{9}{20}H_2O \rightarrow \frac{1}{5}CO_2 + \frac{1}{20} HCO_3^- + \frac{1}{20}NH_4^+ + H^+ + e^-$$  
