...
---
### Problem 2.7
1. 因 $\frac{\lambda_1}{\lambda_2}=\frac{P_2}{P_1}$。
2. 而 $n$ 在密閉容器中不變，故 $\lambda$ 不變。

---
### Problem 2.9
$$V_s=\left(\cfrac{(1.4)(8.314\ \mathrm{J/mol\cdot K})(293\ \mathrm{K})}{29\ \mathrm{g/mol}}\right)^{1/2}=3.4\cdot10^4\ \mathrm{cm/s}$$
